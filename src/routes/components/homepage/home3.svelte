...
<div
  class="flex w-screen flex-col items-center justify-center px-[1.5rem] lg:gap-10 lg:flex-row-reverse lg:items-start">
  ...
  <div class="flex flex-col items-start justify-start lg:w-1/2">
    ...
    <div
      ...
      creating tons of lost opportunity for creators. Content Credentials enable
      creators to get recognition for what they create—helping them build a
      following and market their work.
    </div>
  </div>
</div>
