...
<div
  ...
  <div
    ...
    <h2
      class="w-[27rem] pt-20 text-center text-trust-title xs:w-[22rem] md:w-[40rem] md:text-trust-title-md xl:py-0 xl:text-trust-title-xl 2xl:w-[58rem] 2xl:text-trust-title-xxl">
    ...
    <ul class="hidden justify-center gap-4 xl:flex">
      {#each data as item}
        <li class="w-[389px]">
          ...
          <div
            class="h-full rounded-b-2xl bg-[#F6F5F2] px-[32px] pt-[20px] text-trust-desc xl:text-trust-desc-xl 2xl:text-trust-desc-xxl">
