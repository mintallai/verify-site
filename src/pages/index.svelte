...
<div class="theme-light overflow-show">
  ...
  <section id="section1">
    <div class="grid grid-cols-3 gap-4">
      ...
      <div
        class="w-full col-span-3 lg:col-span-1 order-2 justify-center items-center flex px-4 sm:pb-5">
        <div>
  ...
  <section id="section2">
    <div class="grid grid-cols-3 gap-4">
      ...
      <div
        class="w-full col-span-3 lg:col-span-1 lg:order-1 justify-center items-center flex lg:pl-8 pl-4 pr-4 sm:pb-5">
        <div>
...
<style lang="postcss">
  ...
  .heading {
    @apply text-black font-serif lg:text-5xl text-3xl text-left lg:pb-14 sm:pb-5;
  }

  .body {
    @apply text-black lg:text-xl text-smd text-left pb-5;
  }

  .cta {
    @apply text-black font-bold lg:text-xl sm:text-smd text-left pb-4;
  }
  sp-button {
